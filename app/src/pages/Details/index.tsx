...
const Details = () => {
    ...
    const whatsapp = () => {
        Linking.openURL(`whatsapp://send?phone=55${data.point.whatsapp}&text=Tenho interesse`);
    }
    ...
    return (
        <>
            ...
            <View style={styles.footer}>
                ...
                <RectButton style={styles.button} onPress={mailCompose}>
